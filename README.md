<div align="center">
This repository is now archived and no longer maintained. This was simply a small side project of mine. You'd be better off using <a target="_blank" href="https://cockpit-project.org">Cockpit</a>, which is much more mature and feature-rich.
 <h1> carrotsh <br /> <a target="_blank" href="https://github.com/AnnikaV9/carrotsh/blob/master/pyproject.toml" title="Version"><img src="https://img.shields.io/github/package-json/v/AnnikaV9/carrotsh?label=Version&color=red"></a> <a target="_blank" href="https://github.com/AnnikaV9/carrotsh/blob/master/LICENSE" title="License"><img src="https://img.shields.io/static/v1?label=License&message=The%20Unlicense&color=blue"></a><br /><a href="https://github.com/AnnikaV9/carrotsh/actions/workflows/codeql-analysis.yml"><img src="https://github.com/AnnikaV9/carrotsh/actions/workflows/codeql-analysis.yml/badge.svg?branch=master"></a> <a href="https://github.com/AnnikaV9/carrotsh/actions/workflows/pylint.yml"><img src="https://github.com/AnnikaV9/carrotsh/actions/workflows/pylint.yml/badge.svg"></a> <a href="https://github.com/AnnikaV9/carrotsh/actions/workflows/devskim.yml"><img src="https://github.com/AnnikaV9/carrotsh/actions/workflows/devskim.yml/badge.svg"></a></h1>
A lightweight and secure remote access server that allows clients to connect through a browser.

<br />
<br />

<img src="https://user-images.githubusercontent.com/68383195/182829289-85c62fe0-bafc-4f50-9abd-46f3a7ed2565.gif" width="90%">
</div>
